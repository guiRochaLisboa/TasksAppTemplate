...
class TaskAdapter : RecyclerView.Adapter<TaskViewHolder>() {
    ...
    fun updateList(list: List<TaskModel>) {
        mList = list
        // nossa função notifyDataSetChanged() diz que a listagem foi alterada, os itens que compoem a listagem são diferentes, com o notifyDataSetChanged()
        // a recyclerView sabe que tem que se atualizar.
